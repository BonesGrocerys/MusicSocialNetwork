    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AddedAlbums", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AddedAlbums_Albums_AlbumId",
                        column: x => x.AlbumId,
                        principalTable: "Albums",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AddedAlbums_Persons_PersonId",
                        column: x => x.PersonId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Playlists_Persons_PersonId",
                        column: x => x.PersonId,
                        principalTable: "Persons",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ListenPerson", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ListenPerson_Persons_PersonId",
                        column: x => x.PersonId,
                        principalTable: "Persons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ListenPerson_Tracks_TrackId",
                        column: x => x.TrackId,
                        principalTable: "Tracks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AddedAlbums_AlbumId",
                table: "AddedAlbums",
                column: "AlbumId");

            migrationBuilder.CreateIndex(
                name: "IX_AddedAlbums_PersonId",
                table: "AddedAlbums",
                column: "PersonId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ListenPerson_PersonId",
                table: "ListenPerson",
                column: "PersonId");

            migrationBuilder.CreateIndex(
                name: "IX_ListenPerson_TrackId",
                table: "ListenPerson",
                column: "TrackId");
